...
export function LoginForm({ email, setEmail, password, setPassword, onSubmit, error, message, onToggleSignUp, onForgotPassword }: LoginFormProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="mt-8 space-y-2 text-center">
        <button onClick={onToggleSignUp} className="block w-full font-serif italic text-sm hover:text-accent transition-colors underline underline-offset-4 cursor-pointer text-center">
